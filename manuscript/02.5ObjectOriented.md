...
Object oriented languages allow programmers to declare a function insdie the class definition. Go doesn't allow us to do that, we have to declare a method on a struct via a special syntax.
...
-[Previous section](manuscript/02.4Struct.md)
-[Next section](manuscript/02.6Interface.md)