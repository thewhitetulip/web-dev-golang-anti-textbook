...
We create a variable named url by this syntax, {{$url := ""}}

For creating a variable which initializes the value to .Navigation, replace "" with .Navigation; .Navigation is the data which was rendered by the server on the template.
